...
// 🔥 QUANT KALİBRASYONU: Çok fazla işlem yapıp komisyona ezilmemesi için sınır 100'e çekildi.
pub const MIN_REQUIRED_TRADES: usize = 100; 
pub const MAX_ALLOWED_DD: f64 = 30.0; 

pub const TARGET_WIN_RATE: f64 = 30.0; 
pub const TARGET_PROFIT_FACTOR: f64 = 1.05; 

// 🔥 QUANT KALİBRASYONU: Kâr hedefleri (TP) büyütüldü. 
// Komisyonun %0.04 olduğu yerde hedefin en az %0.5 (0.005) olması şart koşuldu. Tavan %4'e çıkarıldı.
pub const DNA_TP_MIN: f32 = 0.005; 
pub const DNA_TP_MAX: f32 = 0.040; 
pub const DNA_SL_MIN: f32 = 0.002;
pub const DNA_SL_MAX: f32 = 0.025; 
pub const DNA_COOLDOWN_MIN: f32 = 100.0; 
pub const DNA_COOLDOWN_MAX: f32 = 5000.0; // Bekleme süresi artırıldı ki büyük dalgaları bekleyebilsin
...
pub fn print_experiment_manifest(symbol: &str, dataset: &str, gen: usize, pop: usize) {
    ...
    println!("⏹️ Early Stopping: {} Generations without improvement", EARLY_STOP_LIMIT);
