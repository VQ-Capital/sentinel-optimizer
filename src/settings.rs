...
pub const STAGNATION_LIMIT: u32 = 15; // Plaj toleransını artırdık
...
// 🔥 QUANT KALİBRASYONU: Gerçekçi HFT hedefleri (Binde 1 ile Yüzde 1 arası)
pub const DNA_TP_MIN: f32 = 0.001;
pub const DNA_TP_MAX: f32 = 0.010;
pub const DNA_SL_MIN: f32 = 0.001;
pub const DNA_SL_MAX: f32 = 0.005;
