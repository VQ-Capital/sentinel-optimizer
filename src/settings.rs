...
pub const STAGNATION_LIMIT: u32 = 8; // 🔥 CERRAHİ: Durgunluk toleransı artırıldı (Eski: 5)
...
pub const EXTINCTION_DEATH_RATE: f32 = 0.60; // 🔥 CERRAHİ: Kıyamette nüfusun %60'ı silinir (%95 gen havuzunu öldürüyordu)

/// 🎯 3. FİTNESS (UYGUNLUK) HEDEFLERİ VE SINIRLARI
pub const MIN_REQUIRED_TRADES: usize = 250;
pub const MAX_ALLOWED_DD: f64 = 25.0; // 🔥 CERRAHİ: Risk toleransı düşürüldü (Eski: 30)
...
pub const DNA_CONFIDENCE_MAX: f32 = 0.55; // 🔥 CERRAHİ: AI'ın sürekli işlemden kaçmasını engellemek için tavan %55'e çekildi
